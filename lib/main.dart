...
void main() async {
  ...
  await SentryFlutter.init(
    (options) {
      ...
      options.release = const String.fromEnvironment('SENTRY_RELEASE', defaultValue: 'muslim-leveling@1.1.1+24'); // ponytail: sync dengan pubspec version, PackageInfo kalau sering lupa
