...
void main() async {
  ...
  await SentryFlutter.init(
    (options) {
      ...
      options.release = const String.fromEnvironment('SENTRY_RELEASE', defaultValue: 'muslim-leveling@1.1.0+23'); // ponytail: sync dengan pubspec version, PackageInfo kalau sering lupa
