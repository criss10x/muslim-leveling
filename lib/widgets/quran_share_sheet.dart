...
class _BgPreset {
  ...
  final Color fg;
  final Color sub;
  const _BgPreset(this.label, this.icon, this.kind, this.decoration, this.fg,
      this.sub);
}
...
final List<_BgPreset> _bgPresets = [
  // Solid
  _BgPreset('Solid', Icons.circle, _QShareBgKind.solid,
      const BoxDecoration(color: Color(0xFF0B3D2E)), _kFg, _kSub),
  _BgPreset('Solid', Icons.circle, _QShareBgKind.solid,
      const BoxDecoration(color: Color(0xFF101E2B)), _kFg, _kSub),
  _BgPreset('Solid', Icons.circle, _QShareBgKind.solid,
      const BoxDecoration(color: Color(0xFF2B1B33)), _kFg, _kSub),
  _BgPreset('Solid', Icons.circle, _QShareBgKind.solid,
      const BoxDecoration(color: Color(0xFF3B2A10)), _kFg, _kSub),
  // Gradient
  _BgPreset('Gradasi', Icons.gradient, _QShareBgKind.gradient,
      const BoxDecoration(
  ...
  _BgPreset('Gradasi', Icons.gradient, _QShareBgKind.gradient,
      ...
      _kFg, _kSub),
  // Estetik
  _BgPreset('Estetik', Icons.image, _QShareBgKind.esthetic,
...
class _GooglePlayBadge extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      padding: EdgeInsets.symmetric(horizontal: 10 * compact, vertical: 6 * compact),
...
class _QShareCard extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final accent = AppColors.secondaryFixedDim; // bright gold, card bg always dark
    return Container(
      width: 340,
      height: 604,
...
class _QuranShareScreenState extends State<_QuranShareScreen> {
  ...
  void _selectMode(_QShareBgKind kind) {
    ...
    setState(() {
      ...
      _presetIdx = _lastPerKind[kind] ??
          _bgPresets.indexWhere((p) => p.kind == kind);
    });
  }
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    _modeChip(_QShareBgKind.gradient, 'Gradasi',
                        Icons.gradient),
